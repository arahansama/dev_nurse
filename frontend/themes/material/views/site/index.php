                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="../themes/material/dist/img/flags/US.png">
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="../themes/material/dist/img/flags/DE.png">
                                                                </div>
                                                            </td>
                                                            <td>Germany</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="../themes/material/dist/img/flags/AU.png">
                                                                </div>
                                                            </td>
                                                            <td>Australia</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="../themes/material/dist/img/flags/GB.png">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="../themes/material/dist/img/flags/RO.png">
                                                                </div>
                                                            </td>
                                                            <td>Romania</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="../themes/material/dist/img/flags/BR.png">
                                                                </div>
                                                            </td>
                                                            <td>Brasil</td>
                                                            <td class="text-right">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="../themes/material/dist/img/card-2.jpeg">
                                    </a>
                                </div>
                                <div class="card-content">
                                    <div class="card-actions">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="../themes/material/dist/img/card-3.jpeg">
                                    </a>
                                </div>
                                <div class="card-content">
                                    <div class="card-actions">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="../themes/material/dist/img/card-1.jpeg">
                                    </a>
                                </div>
                                <div class="card-content">
                                    <div class="card-actions">
